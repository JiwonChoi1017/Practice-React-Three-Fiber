...
const Water: React.FC<{
  params: {
    uBigWaveElevation: number;
    uBigWavesFrequency: { x: number; y: number };
  ...
  return (
    <mesh rotation-x={-Math.PI * 0.5}>
      ...
      <shaderMaterial
        ...
        uniforms={{
          uTime: { value: 0 },
          uBigWavesElevation: { value: params.uBigWaveElevation },
          uBigWavesFrequency: {
            value: [params.uBigWavesFrequency.x, params.uBigWavesFrequency.y],
          },
          uBigWavesSpeed: { value: params.uBigWavesSpeed },
          uSmallWavesElevation: { value: params.uSmallWavesElevation },
          uSmallWavesFrequency: { value: params.uSmallWavesFrequency },
          uSmallWavesSpeed: { value: params.uSmallWavesSpeed },
          uSmallWavesIterations: { value: params.uSmallWavesIterations },
